...
{
    public partial class frmInvestigationTypes : Form
    {
        InvestigationTypes pt = new InvestigationTypes();
        
        public frmInvestigationTypes()
        {
            InitializeComponent();
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                if (ValidateChildren(ValidationConstraints.Enabled))
                {
                    ...
                    {
                        rtn = pt.InsertInvesType(txtName.Text, txtDesc.Text, chkActive.Checked);
                        if (rtn == -1)
                    ...
                    {
                        rtn = pt.editInvesTypes(Int32.Parse(txtID.Text.Trim()), txtName.Text, txtDesc.Text, chkActive.Checked);
                        if (rtn == 0)
